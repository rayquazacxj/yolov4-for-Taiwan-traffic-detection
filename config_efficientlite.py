...
# ############# Basic configuration. #############
size = width = height = 320                     # image size
batch_size = 4
batch_size_tiny = 32
...
voc_test_dir = "/work/fghuio4000/competition/ivslab_test_public/ivslab_test_public/JPEGImages/All"                                                 # test pictures directory for VOC dataset
voc_save_dir = "/work/fghuio4000/competition/val_iamges"                                                     # the folder to save result image for VOC dataset
voc_model_path = "/work/fghuio4000/competition/models__efficientlitel0320"#"./VOC_parallel_testing_4gpus"###   # the folder to save model for VOC dataset
...
voc_class_num = 4
voc_anchors = 8,10, 13,23, 25,18,  23,47,  48,35, 45,92, 89,69, 120,152, 286,250 #( for 320)
